...
# set an element of the JavaScript 'words' array to a misspelled
word
...
## get the list of misspelled words. Put the results in the
javascript words array
## for each misspelled word, get suggestions and put in the
javascript suggs array
function print_checker_results() {
    ...
    if( $fh = fopen( $tempfile, 'w' )) {
        for( $i = 0; $i < count( $textinputs ); $i++ ) {
            ...
            // Strip all tags for the text. (by FredCK - #339 /
#681)
            ...
            foreach( $lines as $key=>$value ) {
                # use carat on each line to escape possible aspell
commands
                fwrite( $fh, "^$value\n" );
            }
        }
